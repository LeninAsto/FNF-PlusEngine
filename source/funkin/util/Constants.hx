...
class Constants
{
   ...
   */
  public inline static final SAVE_PATH:String = 'LeninAsto/PlusEngine';

  /**
   * The name of our save slot.
   */
  public inline static final SAVE_NAME:String = 'funkin-vslice-';

  /**
   * The legacy path where our save data was saved. Used for backwards compatibility.
   */
  public inline static final SAVE_PATH_LEGACY:String = 'LeninAsto/PlusEngine';

  /**
   * The legacy save slot name, used for backwards compatibility.
   */
  public inline static final SAVE_NAME_LEGACY:String = 'funkin-vslice-legacy';
