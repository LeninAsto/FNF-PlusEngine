...
class FunkinCamera extends FlxCamera
{
  ...
  static inline function get_hasKhronosExtension():Bool
  {
    ...
    return false;
    #else
    return Reflect.field(OpenGLRenderer, "__complexBlendsSupported") == true;
    #end
  }
   ...
   */
  static final KHR_BLEND_MODES:Array<BlendMode> = [DARKEN, HARDLIGHT, #if !desktop LIGHTEN, #end OVERLAY, DIFFERENCE];
      ...
      ?shader:FlxShader):FlxDrawQuadsItem
  {
    ...
    if (hasKhronosExtension && !(Reflect.field(OpenGLRenderer, "__coherentBlendsSupported") == true) && KHR_BLEND_MODES.contains(blend))
    {
      ...
      ?shader:FlxShader):FlxDrawTrianglesItem
  {
    ...
    if (hasKhronosExtension
      && !(Reflect.field(OpenGLRenderer, "__coherentBlendsSupported") == true)
