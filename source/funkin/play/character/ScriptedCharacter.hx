...
/**
 * Compatibility base for mods that extend Pico's official playable character class.
 */
@:hscriptClass
class ScriptedPicoPlayerBaseCharacter extends PicoPlayerBaseCharacter implements polymod.hscript.HScriptedClass
{
}
