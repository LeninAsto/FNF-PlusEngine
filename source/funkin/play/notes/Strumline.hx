...
class Strumline extends FlxSpriteGroup
{
  ...
  final inArrowControlSchemeMode:Bool = #if mobile (Preferences.controlsScheme == FunkinHitboxControlSchemes.Arrows && ClientPrefs.data.mobileReceptorAlign
    && !ControlsHandler.hasExternalInputDevice) #else false #end;

  /**
   * Whether the strumline is downscroll.
   */
  public var isDownscroll:Bool = #if mobile (Preferences.controlsScheme == FunkinHitboxControlSchemes.Arrows && ClientPrefs.data.mobileReceptorAlign
