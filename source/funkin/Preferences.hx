...
class Preferences
{
	...
	static function set_autoPause(value:Bool):Bool
	{
		...
		return false;
		#else
		if (value != Save.instance.options.autoPause)
	...
	{
		if (value != Save.instance.mobileOptions.screenTimeout)
	...
	{
		if (InAppPurchasesUtil.hasInitialized)
			noAds = InAppPurchasesUtil.isPurchased(InAppPurchasesUtil.UPGRADE_PRODUCT_ID);
