...
class DataParse
{
	...
	public static function stringNotEmpty(json:Json, name:String):String
	{
		switch (json.value)
		{
			case JString(s):
				if (s == "")
					throw 'Expected property $name to be non-empty.';
				return s;
			default:
	...
	public static function semverVersion(json:Json, name:String):Version
	{
		switch (json.value)
		{
			case JString(s):
				if (s == "")
					throw 'Expected version property $name to be non-empty.';
				return s;
			default:
	...
	public static function semverVersionRule(json:Json, name:String):VersionRule
	{
		switch (json.value)
		{
			case JString(s):
				if (s == "")
					throw 'Expected version rule property $name to be non-empty.';
				return s;
			default:
		...
		switch (json.value)
		{
			case JArray(values):
				...
				if (time == null || data == null)
					throw 'Property $name note is missing time and/or data values.';
